...
Designed to complement comprehensive policy tools like Sanoid, diffsnap manages and prunes only its own snapshots. It to safely coexists alongside existing retention systems.
